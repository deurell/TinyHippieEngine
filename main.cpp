...
int main() {
    ...
    const char* microPath = "Resources/sup.jpg";
    ...
    const char* zebraPath = "Resources/sup.png";
    ...
    while(!glfwWindowShouldClose(window)){
        ...
        transform = glm::rotate(transform, glm::radians<float>(0), glm::vec3(0.0f, 0.0f, 1.0f));
